...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        volumeButtonManager = VolumeButtonManager(this, viewModel, parentName = "None")
    ...
    private lateinit var volumeButtonManager: VolumeButtonManager

    override fun onKeyDown(keyCode: Int, event: KeyEvent?): Boolean {
        if (event?.repeatCount == 0) { // Only handle the first press, ignore repeats
            if (volumeButtonManager.handleVolumeKeyEvent(keyCode)) {
