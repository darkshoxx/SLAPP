...
class MathsLibTest{
    ...
    fun testRelativeAngleSegments(){
        ...
        val result1 = calculateRegion(px=540.0f, py=1300.0f, cx=540.0f, cy=1200.0f)
        val result2 = calculateRegion(px=640.0f, py=1300.0f, cx=540.0f, cy=1200.0f)
        val result3 = calculateRegion(px=640.0f, py=1100.0f, cx=540.0f, cy=1200.0f)
        val result4 = calculateRegion(px=540.0f, py=1100.0f, cx=540.0f, cy=1200.0f)
        val result5 = calculateRegion(px=440.0f, py=1100.0f, cx=540.0f, cy=1200.0f)
        val result6 = calculateRegion(px=440.0f, py=1300.0f, cx=540.0f, cy=1200.0f)
        assertEquals(1, result1)
        assertEquals(2, result2)
        assertEquals(3, result3)
        assertEquals(4, result4)
